...
export const rooms: Room[] = [
    ...
    { id: 5, title: 'Room 5', time: '9:00 AM', modal: "1", modalContent: ['Không bật được đèn nhà tắm'], details: 'This is more detailed information about Room 5.' },
];
const King: React.FC<Props> = ({ isGridView,  searchValue }) => {
    const { Meta } = Card;
